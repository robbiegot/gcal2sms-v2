...
-- AddForeignKey
ALTER TABLE "ContactsOnEvents" ADD CONSTRAINT "ContactsOnEvents_eventId_fkey" FOREIGN KEY ("eventId") REFERENCES "Event"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
